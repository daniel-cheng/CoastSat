    ...
    for satname in metadata.keys():
        ...
        for i in range(len(filenames)):   
            ...
            try: # use try/except structure for long runs
                ...
                print('Could not map shoreline for this image: ' + filenames[i], E)
                continue
            # process the water contours into a shoreline
            shoreline = SDS_shoreline.process_shoreline(contours_mwi, cloud_mask, im_nodata, georef, image_epsg, settings)
            try:
